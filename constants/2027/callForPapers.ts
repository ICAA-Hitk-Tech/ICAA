export const CFP_HEADING = "Final Call for Papers";
...
export const CFP_PUBLICATION_NOTE =
  "Proceedings of ICAA 2027 will be published as part of the Springer Verlag LNCS volume.";

/** Relative path for the downloadable PDF — place the file in /public */
export const CFP_PDF_PATH =
  "https://drive.google.com/file/d/16BtUcPOFaGw9PmEy6zwGhlAoUrkZ0H-i/view?usp=sharing";
