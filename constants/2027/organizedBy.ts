...
export const DEPARTMENT_TEXT =
    `Department of Computer Science and Engineering was started in 2001. The department has the vision to meet the challenges of the 21st century and become a Centre of Excellence in the field of Computer Science & Engineering.`;

export const DEPARTMENT_VISION_QUOTE =
    `"To meet the challenges of the 21st century and become a Centre of Excellence in Computer Science & Engineering."`;

export const INSTITUTE_TAGS = [
    "Founded 2001",
    "MAKAUT Affiliated",
    "NAAC 'A' Grade",
    "Kalyan Bharti Trust",
