    ...
    <>
      ...
      <div className="hidden lg:flex flex-row px-6 md:px-12 lg:px-16 pt-28 pb-16 gap-12 lg:gap-16 items-center w-full">
        ...
        <div className="flex flex-col gap-5 w-full lg:w-1/2">
          <span className="text-abyss-500 font-mono font-extrabold lg:text-2xl tracking-wider uppercase">
            January 06, 2027 – January 08, 2027
          </span>
          <span className="text-grove-800 font-sans font-extrabold lg:text-3xl tracking-wider">
          ...
          <div className="flex flex-wrap gap-4 mt-4">
            <button className="flex items-center gap-2 px-6 py-3 border-2 border-ink bg-chrome-400 text-ink font-bold -translate-x-1 -translate-y-1 shadow-[4px_4px_0px_0px_var(--color-ink)] hover:bg-chrome-600 active:translate-x-0 active:translate-y-0 active:shadow-none transition-all duration-150">
      ...
      <div className="flex lg:hidden flex-col px-6 pt-24 pb-12 gap-8 w-full">
        ...
        <div className="w-full flex justify-center items-center">
          <div className="relative w-full max-w-sm md:max-w-xl bg-surface border-2 border-ink p-2 md:p-2.5 shadow-[6px_6px_0px_0px_var(--color-ink)] md:shadow-[8px_8px_0px_0px_var(--color-ink)] -rotate-1 select-none">
            ...
            />
            {/* Floating Sticker / Tag */}
            <div className="absolute -top-3.5 -right-3.5 bg-chrome-400 text-ink text-[10px] md:text-xs font-mono font-bold px-2 py-1 md:px-3 md:py-1.5 border border-ink shadow-[1.5px_1.5px_0px_0px_var(--color-ink)] md:shadow-[2px_2px_0px_0px_var(--color-ink)] rotate-6 uppercase">
              Welcome To
            </div>
            {/* Floating Sticker / Tag at bottom-left */}
            <div className="absolute -bottom-3.5 -left-3.5 bg-abyss-500 text-paper text-[10px] md:text-xs font-mono font-bold px-2 py-1 md:px-3 md:py-1.5 border border-ink shadow-[1.5px_1.5px_0px_0px_var(--color-ink)] md:shadow-[2px_2px_0px_0px_var(--color-ink)] -rotate-6 uppercase">
              ICAA 2027!!
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-row gap-3 w-full md:w-auto md:justify-center md:mx-auto md:gap-4">
          <button className="flex-1 md:flex-initial flex items-center justify-center gap-1.5 px-3 md:px-6 py-2.5 md:py-3 border-2 border-ink bg-chrome-400 text-ink text-xs md:text-sm font-bold -translate-x-1 -translate-y-1 shadow-[4px_4px_0px_0px_var(--color-ink)] hover:bg-chrome-600 active:translate-x-0 active:translate-y-0 active:shadow-none transition-all duration-150 whitespace-nowrap">
            <FaLaptop className="w-4 h-4" />
            <span>In Hybrid Mode</span>
          </button>
          <Link href="/2027/papersubmission" className="flex-1 md:flex-initial">
            <button className="w-full flex items-center justify-center gap-1.5 px-3 md:px-6 py-2.5 md:py-3 border-2 border-ink bg-sea-500 text-paper text-xs md:text-sm font-bold -translate-x-1 -translate-y-1 shadow-[4px_4px_0px_0px_var(--color-ink)] hover:bg-sea-700 active:translate-x-0 active:translate-y-0 active:shadow-none transition-all duration-150 cursor-pointer whitespace-nowrap group">
