...
const InfoCard = ({
	...
	<div className="group flex flex-col border-2 border-ink bg-surface shadow-[5px_5px_0px_0px_var(--color-ink)] hover:shadow-[7px_7px_0px_0px_var(--color-ink)] hover:-translate-y-0.5 transition-all duration-200">
		{/* Header bar */}
		<div className={`flex items-center gap-3 border-b-2 border-ink ${accentClass} px-5 py-3`}>
