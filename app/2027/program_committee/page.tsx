...
export const metadata: Metadata = { title: "Program Committee — ICAA 2027" };
...
export default function ProgramCommitteePage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 gap-4">
      <span className="font-mono text-xs uppercase tracking-widest text-ink-ghost border border-border px-3 py-1">Program Committee</span>
      ...
      <p className="text-ink-dim text-center max-w-md">
        The program committee for ICAA 2027 will be listed here once finalised.
      </p>
    </div>
  );
}
