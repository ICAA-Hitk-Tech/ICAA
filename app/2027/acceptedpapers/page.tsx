...
export const metadata: Metadata = { title: "Accepted Papers — ICAA 2027" };
...
export default function AcceptedPapersPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 gap-4">
      <span className="font-mono text-xs uppercase tracking-widest text-ink-ghost border border-border px-3 py-1">Accepted Papers</span>
      ...
      <p className="text-ink-dim text-center max-w-md">
        The list of accepted papers for ICAA 2027 will be posted here after the review process.
      </p>
      <Link href="/2027">
