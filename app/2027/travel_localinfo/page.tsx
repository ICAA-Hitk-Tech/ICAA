...
export const metadata: Metadata = { title: "Travel & Local Info — ICAA 2027" };

export default function TravelLocalInfoPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 gap-4">
      <span className="font-mono text-xs uppercase tracking-widest text-ink-ghost border border-border px-3 py-1">Travel & Local Info</span>
      ...
      <p className="text-ink-dim text-center max-w-md">
        Travel guidance and local information for visitors attending ICAA 2027 will be published here.
      </p>
