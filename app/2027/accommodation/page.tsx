...
export const metadata: Metadata = { title: "Accommodation — ICAA 2027" };

export default function AccommodationPage() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-6 pt-24 gap-4">
      <span className="font-mono text-xs uppercase tracking-widest text-ink-ghost border border-border px-3 py-1">Accommodation</span>
      ...
      <p className="text-ink-dim text-center max-w-md">
        Information about accommodation options and deals for ICAA 2027 attendees will be posted here.
      </p>
      <Link href="/2027">
